...
import CAAModule from '../components/CAAModule';
...
const TABS = [
  ...
  { id: 1, label: 'Acoustic Awareness', emoji: '📡' },
  { id: 2, label: 'Leaderboard',      emoji: '🏆' },
  { id: 3, label: 'Analytics',        emoji: '📊' },
  { id: 4, label: 'Dashboard',        emoji: '🏫' },
  { id: 5, label: 'Rewards',          emoji: '🎖️' },
  { id: 6, label: 'Reports',          emoji: '📋' },
  { id: 7, label: 'Settings',         emoji: '⚙️' },
